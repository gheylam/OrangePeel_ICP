...
int main(int argc, char* args[]){
    ...
    double noiseMin = 0;        //Minimum noise added to the vertices
    double noiseMax = 0.0009;     //Maximum noise added to the vertices
    double noiseIncr = 0.0001;   //Standard Deviation increment amount
    vector<double> sdNoise;
    ...
    Gnuplot g1("lines");
    cout << "sdNoise: " << sdNoise.size() << endl;
    cout << "iterationsDone: " << iterationsDone.size() << endl;
    g1.set_xlabel("standard deviations");
